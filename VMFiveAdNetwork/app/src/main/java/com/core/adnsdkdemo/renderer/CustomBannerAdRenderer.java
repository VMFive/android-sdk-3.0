...
import com.core.adnsdk.BannerViewHolder;
...
public class CustomBannerAdRenderer implements AdRenderer {
    ...
    public CustomBannerAdRenderer(BannerViewBinder nativeBannerViewBinder) {
    ...
    public View createAdView(Context context, ViewGroup parent, AdBaseSpec baseSpec) {
        ...
        BannerViewHolder holder = BannerViewHolder.createFromBinder(view, mBannerViewBinder);
        view.setTag(holder);
    ...
    public void loadingAdView(View view, AdObject adObject) {
        BannerViewHolder holder = (BannerViewHolder)view.getTag();
